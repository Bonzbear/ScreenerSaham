...
def backtest_ev(df):
    ...
    # 1. Jika tidak ada sinyal sama sekali, kembalikan 3 nilai (0, 0, 0)
    if total_trades == 0:
        return 0, 0, 0
    ...
    # 3. Hitung rata-rata profit saja (atau ganti dengan sum(returns)/total_trades jika ingin EV standar)
    ...
    # 4. Kembalikan 3 nilai sesuai yang diminta run_screener
