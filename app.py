...
def calculate_winrate(df):
    ...
    w1 = (win_v1/total_v1*100) if total_v1 else None
    w2 = (win_v2/total_v2*100) if total_v2 else None
...
def run_screener():
    ...
    for i, ticker in enumerate(TICKERS):
        ...
        if "V1" in signals and w1:
            winrates.append(w1)

        if "V2" in signals and w2:
            winrates.append(w2)
