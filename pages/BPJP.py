...
st.title("Screener Hari Ini + Backtest Historis")
...
def backtest(df):
    ...
    for i in range(21, len(df)-1):
        ...
        # pakai logic yang sama seperti screener
        if today["Volume"] <= prev["Volume"]:
            continue
...
# MAIN
# =========================
if st.button("Run Screener & Backtest"):
    ...
    if len(selected) == 0:
        st.warning("Tidak ada saham yang lolos screener hari ini")
    else:
        st.write("## 📊 Backtest Saham Terpilih")
